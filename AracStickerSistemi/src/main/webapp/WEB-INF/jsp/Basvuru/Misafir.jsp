...
<div class="container-lg" style="text-align: center; margin-top: 50px;">
    <form:form action="misafir" modelAttribute="misafir">
        <div class="row">
            <div class="col-sm-6">
                <div class="jumbotron">
                ...
                <div class="jumbotron">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <form:input cssClass="form-control" placeholder="Tc" path="misafirTcNo" disabled="true"/>
                        </div>
                        <div class="col-sm-4">
                            <label class="col-form-label">ADSOYAD</label>
                            <form:input cssClass="form-control" placeholder="Adsoyad" path="misafirAdSoyad" disabled="true"/>
                        </div>
                        <div class="col-sm-4">
