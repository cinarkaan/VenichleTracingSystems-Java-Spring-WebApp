...
<head>
    ...
    <title>MisafirStickerDüzenle</title>
</head>
...
<div class="container-lg"  style="text-align: center; margin-top: 50px;">
    <form:form method="post" action="${pageContext.request.contextPath}/editMisafirStickerSave" modelAttribute="updateMisafirSticker">
        <div class="row">
            <div class="col-sm-6">
                <div class="jumbotron">
