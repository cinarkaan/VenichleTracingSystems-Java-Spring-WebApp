...
<body style="background-color: #d2d6de">
    <div class="container" STYLE="margin-top: 70px">
        <h3 class="h3" style="text-align: center">MEU TAŞIT STİCKER SİSTEMİ KULLANICI EKLEME</h3>
        <form:form cssClass="form-group" method="post" action="AddUser" modelAttribute="addUser" >
            <div class="row jumbotron">
                ...
                <div class="col-sm-4">
                    ...
                    <form:input path="password" cssClass="form-control" placeholder="Parola"/>
                ...
                <div class="col-sm-4">
                    <label class="col-form-label">YETKİ :</label>
                    <form:select cssClass="form-control" path="stickerTur">
                        <form:option value="NONE" label="Select"/>
                        <form:options items="${kullanıcıtur}"/>
                    </form:select>
                </div>
                <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                    ...
                    <form:select cssClass="form-control" path="kampusbirim">
                        <form:option value="" label="Select"/>
