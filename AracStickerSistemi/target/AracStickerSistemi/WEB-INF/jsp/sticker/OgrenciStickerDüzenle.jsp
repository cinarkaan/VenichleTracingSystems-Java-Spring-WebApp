...
<head>
    ...
    <title>OgrenciStickerDüzenle</title>
</head>
...
<div class="container-lg" style="text-align: center; margin-top: 50px;">
    <form:form method="post" modelAttribute="updateOgrenciSticker" action="${pageContext.request.contextPath}/editOgrenciStickerSave">
        <div class="row">
            <div class="col-sm-6">
                <div class="jumbotron">
