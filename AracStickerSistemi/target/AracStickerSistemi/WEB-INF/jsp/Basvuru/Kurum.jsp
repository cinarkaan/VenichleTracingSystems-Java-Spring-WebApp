...
<div class="container-lg" style="text-align: center; margin-top: 50px;">
    <form:form action="kurum" modelAttribute="kurum">
        <div class="row">
            <div class="col-sm-6">
                <div class="jumbotron">
                ...
                <div class="jumbotron">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <form:input cssClass="form-control" placeholder="Adsoyad" path="adSoyad" disabled="true"/>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <form:input cssClass="form-control" placeholder="Tc" path="tcNo" disabled="true"/>
                        </div>
                        <div class="col-sm-4">
